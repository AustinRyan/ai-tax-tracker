            ...
            <div className="md:grid md:grid-cols-12 md:gap-x-5">
              ...
              <aside className="py-6 px-4 sm:px-6 md:py-0 md:px-0 md:col-span-3 border-b md:border-b-0 md:border-r border-gray-200">
                <nav className="space-y-1">
                  ...
                  >
                    <User className={`mr-3 h-5 w-5 ${activeTab === 'profile' ? 'text-blue-500' : 'text-gray-400'
                      }`} />
                    Profile
                  </button>
                  <button
                    onClick={() => setActiveTab('password')}
                    className={`flex items-center px-3 py-2 text-sm font-medium rounded-md w-full ${activeTab === 'password'
                      ? 'bg-blue-50 text-blue-700'
                      : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'
                      }`}
                  >
                    <Lock className={`mr-3 h-5 w-5 ${activeTab === 'password' ? 'text-blue-500' : 'text-gray-400'
                      }`} />
                    Password
                  </button>
                  <button
                    onClick={() => setActiveTab('billing')}
                    className={`flex items-center px-3 py-2 text-sm font-medium rounded-md w-full ${activeTab === 'billing'
                      ? 'bg-blue-50 text-blue-700'
                      : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'
                      }`}
                  >
                    <CreditCard className={`mr-3 h-5 w-5 ${activeTab === 'billing' ? 'text-blue-500' : 'text-gray-400'
                      }`} />
                    Billing
                  </button>
                  <button
                  ...
                  >
                    <Bell className={`mr-3 h-5 w-5 ${activeTab === 'notifications' ? 'text-blue-500' : 'text-gray-400'
                      }`} />
                    Notifications
                  </button>
                  <button
                  ...
                  >
                    <Shield className={`mr-3 h-5 w-5 ${activeTab === 'security' ? 'text-blue-500' : 'text-gray-400'
                      }`} />
                    Security
                  </button>
                  <button
                    onClick={() => setActiveTab('help')}
                    className={`flex items-center px-3 py-2 text-sm font-medium rounded-md w-full ${activeTab === 'help'
                      ? 'bg-blue-50 text-blue-700'
                      : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'
                      }`}
                  >
                    <HelpCircle className={`mr-3 h-5 w-5 ${activeTab === 'help' ? 'text-blue-500' : 'text-gray-400'
                      }`} />
                    Help & Support
                  </button>
                </nav>
